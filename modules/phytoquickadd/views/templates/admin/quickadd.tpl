    ...
    <div class="panel-body">
        ...
        <div class="well">
            ...
            <div id="ai_loading" style="display:none;margin-top:10px;">
                <i class="icon-spinner icon-spin"></i> Generating...
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="product_short_description" id="product_short_description" class="form-control" rows="2"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Full Description</label>
                        <textarea name="product_description" id="product_description" class="form-control" rows="6"></textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="product_quantity" class="form-control" min="0" required value="1">
                    </div>
                    <div class="form-group">
